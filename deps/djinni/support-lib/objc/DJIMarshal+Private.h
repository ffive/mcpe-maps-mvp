...
namespace djinni {
    ...
    struct Bool {
        ...
        struct Boxed {
            ...
            static ObjcType fromCpp(CppType x) noexcept {
                return [NSNumber
                        numberWithBool:
                Bool::fromCpp(x)];
            }
    ...
    struct Primitive {
        ...
        struct Boxed {
            ...
            static CppType toCpp(ObjcType x) noexcept {
                assert(x);
                return static_cast<CppType>(Self::unbox(x));
            }
    ...
    class I8 : public Primitive<I8, int8_t> {
        ...
        static char unbox(Boxed::ObjcType x) noexcept {
            return [x
            charValue];
        }

        static Boxed::ObjcType box(CppType x) noexcept {
            return [NSNumber
                    numberWithChar:
            static_cast<char>(x)];
        }
    ...
    class I16 : public Primitive<I16, int16_t> {
        ...
        static short unbox(Boxed::ObjcType x) noexcept {
            return [x
            shortValue];
        }
    ...
    class I32 : public Primitive<I32, int32_t> {
        ...
        static int unbox(Boxed::ObjcType x) noexcept {
            return [x
            intValue];
        }
    ...
    class I64 : public Primitive<I64, int64_t> {
        ...
        static long long unbox(Boxed::ObjcType x) noexcept {
            return [x
            longLongValue];
        }
    ...
    class F32 : public Primitive<F32, float> {
        ...
        static CppType unbox(Boxed::ObjcType x) noexcept {
            return [x
            floatValue];
        }
    ...
    struct Enum {
        ...
        struct Boxed {
            ...
            static CppType toCpp(ObjcType x) noexcept {
                return Enum::toCpp(static_cast<Enum::ObjcType>([x
                integerValue]));
            }
            ...
            static ObjcType fromCpp(CppType x) noexcept {
                return [NSNumber
                        numberWithInteger:
                static_cast<NSInteger>(Enum::fromCpp(x))];
            }
        };
    };
    ...
    struct String {
        ...
        static ObjcType fromCpp(const CppType &string) {
            ...
            string.data()
            length:
            static_cast<NSUInteger>(string.size())
            encoding:
    ...
    struct Date {
        ...
        static CppType toCpp(ObjcType date) {
            ...
            auto timeIntervalSince1970 = duration<double>([date
        ...
        static ObjcType fromCpp(const CppType &date) {
            ...
            duration_cast<duration<double>>(date - POSIX_EPOCH).count()];
    ...
    public:
        ...
        static ObjcType fromCpp(const CppType &v) {
            ...
            auto array = [NSMutableArray
                    arrayWithCapacity:
            static_cast<NSUInteger>(v.size())];
            for (const auto &value : v) {
                [array
                        addObject:
                T::Boxed::fromCpp(value)];
            }
            return array;
        }
    };
    ...
    public:
        ...
        static ObjcType fromCpp(const CppType &s) {
            ...
            auto set = [NSMutableSet
                    setWithCapacity:
            static_cast<NSUInteger>(s.size())];
    ...
    public:
        ...
        static CppType toCpp(ObjcType map) {
            ...
            ^(ObjcKeyType key, ObjcValueType obj, BOOL *) {
        ...
        static ObjcType fromCpp(const CppType &m) {
            ...
            auto map = [NSMutableDictionary
                    dictionaryWithCapacity:
            static_cast<NSUInteger>(m.size())];
            for (const auto &kvp : m) {
                [map
                        setObject:
                Value::Boxed::fromCpp(kvp.second)
                forKey:
                Key::Boxed::fromCpp(kvp.first)];
            }
            return map;
        }
    };
