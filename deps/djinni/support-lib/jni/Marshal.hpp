...
namespace djinni {
    ...
    protected:
        Primitive(const char *javaClassSpec,
                ...
                : clazz(jniFindClass(javaClassSpec)), method_box(jniGetStaticMethodID(clazz.get(), staticBoxMethod, staticBoxMethodSignature)), method_unbox(jniGetMethodID(clazz.get(), unboxMethod, unboxMethodSignature)) { }
