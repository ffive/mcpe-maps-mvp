...
typedef void (^__nullable
DJIObjCPlatformThreadsConfigBlock)(
NSThread *__nonnull
thread);
typedef void (^__nonnull
DJIThreadFuncBlock)();
 ...
 */
@
interface DJIObjCPlatformThreads :
NSObject <DBPlatformThreads>

- (
nullable instancetype
)init __attribute__((unavailable("Please use factory method instead.")));
