...
import com.sopa.mvvc.datamodel.network.asynchttp.LoadingListener;
import com.sopa.mvvc.datamodel.network.asynchttp.MapDownloader;
import com.sopa.mvvc.datamodel.network.retrofit.BackendlessApiREST;
import com.sopa.mvvc.datamodel.network.retrofit.ServiceGenerator;
import com.sopa.mvvc.presentation.presenter.blank.DetailsPresenter;
...
*/
    ...
    public void openApp() {
        ...
        new AlertDialog.Builder(getContext())
                .setTitle(getString(R.string.dialog_launch_title))
                .setMessage(getString(R.string.dialog_launch_message))
                .setPositiveButton(getString(R.string.dialog_launch_btn_ok), (dialogInterface, i) -> {
